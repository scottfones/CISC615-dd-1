...
# a reorganization.
#
# $Id: charconv.py,v 2.2 1999/06/14 21:34:18 larsga Exp $
...
def cp850_to_iso8859(data):
    return data.translate(cp850_iso_tbl)


def iso8859_to_cp850(data):
    return data.translate(iso_cp850_tbl)
...
def cp1252_to_iso8859(data):
    return data.translate(cp1252_iso_tbl)
...
class ConverterDatabase:
    ...
    def add_alias(self, canonical, alias):
        ...
        self.__alias_map[alias.lower()] = canonical.lower()
    ...
    def add_converter(self, from_encoding, to_encoding, converter):
        ...
        if not from_encoding in self.__map:
