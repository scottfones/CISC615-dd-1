...
from xmlproc.xmldtd import InternalEntity, ExternalEntity
from xmlproc.xmlutils import XMLCommonParser, OutOfDataException, whitespace, reg2code, EntityParser, \
    reg_pe_ref, reg_litval_stop, unhex, reg_attr_type, reg_name, reg_nmtoken, reg_cond_sect
...
class DTDConsumerPE(DTDConsumer):
    ...
    def new_parameter_entity(self, name, val):
        if not name in self.param_ents:  # Keep first decl
