...
english = {
    ...
    2015: "xmlproc:space must be declared an enumeration type",
    2016: "xmlproc:space must have exactly the values 'default' and 'preserve'",
    ...
    3045: "Processing instruction target names beginning with 'xmlproc' are reserved",
...
norsk = {
    ...
    2015: "xmlproc:space må deklareres som en oppramstype",
    2016: "xmlproc:space må ha verdiene 'default' og 'preserve'",
    ...
    3045: "Processing instruction navn som begynner med 'xmlproc' er reservert",
