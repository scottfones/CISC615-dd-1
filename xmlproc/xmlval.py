...
# The validator class
# ==============================
from xmlproc.xmlapp import Application, PubIdResolver
from xmlproc.xmldtd import CompleteDTD
...
class XMLValidator:
    ...
    def get_raw_construct(self):
        ...
        return self.parser.data[self.parser.prepos:self.parser.self.pos]
...
class ValidatingApp(Application):
    ...
    def handle_start_tag(self, name, attrs):
        ...
        elif decl_root is not None and name != decl_root:
    ...
    def handle_end_tag(self, name):
        ...
        if self.cur_elem is not None and \
    ...
    def handle_data(self, data, start, end):
        ...
        if self.cur_elem is not None and self.cur_state != -1:
    ...
    def validate_attributes(self, element, attrs):
        ...
        for attr in attrs.keys():
            ...
            if decl.type != "CDATA":
                attrs[attr] = "".join(attrs[attr].split())
            ...
            if decl.type == "ID":
                ...
                for ent_ref in attrs[attr].split():
